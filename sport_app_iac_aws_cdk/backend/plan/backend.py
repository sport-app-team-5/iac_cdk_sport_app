...
class PlanBackend(Stack):
    ...
    def __init__(self, scope: Construct, _id: str, vpc, pipeline, secret, **kwargs) -> None:
        ...
        self.secret = secret
        self.fargate_cluster_name = 'PlanCluster'
        self.load_balancer_name = 'PlanLB'
        self.load_balancer_listener_name = 'PlanListener'
        self.fargate_task_name = 'PlanTask'
        self.fargate_container_name = 'PlanContainer'
        self.fargate_service_name = 'PlanService'
