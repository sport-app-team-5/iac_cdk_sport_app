...
class UserBackend(Stack):
        ...
        self.task_definition.add_container(self.fargate_container_name,
                                           ...
                                           logging=ecs.AwsLogDriver(
                                               ...
                                               log_group=logs.LogGroup(
                                                   self, 'UserBackendLogGroup',
                                                   log_group_name='/aws/ecs/UserBackendTask',
                                               )
                                           ))
    ...
    def add_listener_to_load_balancer(self):
        self.listener.add_targets("UserServiceTargets", port=80, targets=[self.ecs_service])
